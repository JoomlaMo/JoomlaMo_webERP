...
class teamsModelleaguess extends JModel
{
    var $_data;
    var $_total = null;
    ...
    function __construct()
    {
        ...
        If($mainframe->getUserState( "searchsource") <> 'leagues'){
        	$this->search='';
        }       
    ...
    function _buildQuery()
    {
        ...
        if (($this->filter_order=='Name' OR $this->filter_order=='Description') && ($this->filter_order_Dir))
        {
