...
require_once(JPATH_COMPONENT . DS . 'pdfb' . DS . 'fpdf_fpdi' . DS . "fpdf_tpl.php");
require_once(JPATH_COMPONENT . DS . 'pdfb' . DS . 'fpdf_fpdi' . DS . "fpdi_pdf_parser.php");
...
class fpdi extends fpdf_tpl {
     ...
     * See FPDF-Manual
     */
    function fpdi($orientation='P',$unit='mm',$format='Letter') {
