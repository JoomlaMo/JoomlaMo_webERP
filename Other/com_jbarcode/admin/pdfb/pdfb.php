...
*/
  ...
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'fpdf_fpdi' . DS . 'fpdi.php');
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . 'barcodeimage.php');
  ...
  class PDFB extends FPDI
  {
    ...
    function BarCode($barcode, $type="", $x=0, $y=0, $w=500, $h=100, $sx=0.18, $sy=0.40, $xres=4, $font=5, $link="", $format="PNG")
    {
