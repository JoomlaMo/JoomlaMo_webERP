...
*/
  ...
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . "barcode.php");
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . "c39.php");
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . "c128a.php");
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . "c128b.php");
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . "c128c.php");
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . "i25.php");
  require(JPATH_COMPONENT . DS . 'pdfb' . DS . 'barcode' . DS . "upca.php");
