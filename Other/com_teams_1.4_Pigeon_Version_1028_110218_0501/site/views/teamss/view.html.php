 ...
 */
// echo "stop 23 teams view<br>";exit;
//-- No direct access
...
class teamsViewteamss extends JView
{
    ...
    function display($tpl = null)
    {
		...
		$document->setTitle( JText::_('Teams') );


      $items  = & $this->get('Data');
		$LeagueNames = teamsHelper::getLeagueNames();
      If(count($items)>0){
      ...
      $this->assignRef('leaguenames', $LeagueNames);
