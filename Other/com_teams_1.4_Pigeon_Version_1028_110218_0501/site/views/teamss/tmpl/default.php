    ...
    <table>
        <tr>
            <td align="left" width="100%">
                <?php echo JText::_('NAME_FILTER'); ?>:
                <input type="text" name="search" id="search" value="<?php echo $this->lists['search'];?>" class="text_area" onchange="document.adminForm.submit();" />
                <input type="hidden" name="searchsource" value="teams">
        ...
        <table class="adminlist">
            <thead>
                <tr>
                    ...
                    <?php $coloumnCount = 2; ?>
                        <!-- <th>
        <?php echo JHTML::_('grid.sort', 'TeamID', 'TeamID', $this->lists['order_Dir'], $this->lists['order']);?>
    </th> -->
<?php
...
?>     
    ...
    <th>
        <?php echo JHTML::_('grid.sort', 'LEAGUE', 'LEAGUE', $this->lists['order_Dir'], $this->lists['order']);?>
    </th>
<?php
}else {
?>     
...
?>
    ...
    <?php $coloumnCount += 6; ?>
            ...
            {
                $row = &$this->items[$i];
                $link = JRoute::_('index.php?option=com_teams&controller=team&task=edit&cid[]='. $row->TeamID);

                $checked = JHTML::_('grid.id',  $i, $row->TeamID );
            ?>
    ...
    <td>
        <?php echo $row->TeamDescription; ?>
    </td>
    <td>
        <?php echo $this->leaguenames[$row->TeamLeague]["LeagueName"]; ?>
    </td>
    <!-- <td>
        <?php echo $row->Login; ?>
    </td>
