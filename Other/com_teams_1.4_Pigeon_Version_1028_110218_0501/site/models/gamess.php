...
class teamsModelgamess extends JModel
{
    var $_data;
    var $_total = null;
    ...
    function __construct()
    {
        ...
        If($mainframe->getUserState( "searchsource") <> 'games'){
        	$this->search='';
        }
    ...
    function _buildQuery()
    {
        ...
        if ($this->search)
        {
            $where[] = 'LOWER(Opponent) LIKE \''. $this->search. '\'';
        }
        ...
        if (($this->filter_order=='Date' OR
          	 $this->filter_order=='Time' OR
          	 $this->filter_order=='Opponent' OR  	 
          	 $this->filter_order=='Location' OR	 
          	 $this->filter_order=='Team' OR   	 
          	 $this->filter_order=='Uniform' OR  	 
          	 $this->filter_order=='Directions' OR  	 
          	 $this->filter_order=='Us' OR  	 
          	 $this->filter_order=='Them') && ($this->filter_order_Dir))
        {
