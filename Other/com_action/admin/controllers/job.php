...
class ActionsControllerjob extends JController
{
	var $cid;
	...
	{
		$this->_query = 'UPDATE #__action_job'
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_Action&view=jobs', $msg );
	}
	function publish()
	{
		...
		$link = 'index.php?option=com_Action&view=jobs';
	...
	function _reOrder($direction)
	{
		...
		$mainframe->redirect('index.php?option=com_Action&view=jobs');
	}
	...
	function saveorder()
	{
		...
		$mainframe->redirect('index.php?option=com_Action&view=jobs', $msg);
	}
