...
<div id="tablecell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort',   'ProcessCheckListID', 'ProcessCheckListID', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th class="title">
	...
	{
		$row = &$this->items[$i];
		$link 		= JRoute::_( 'index.php?option=com_Action&controller=processlink&task=edit&cid[]='. $row->id);
	...
	?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit processlink' );?>::<?php echo $row->title; ?>">
...
?>    
	...
	<input type="hidden" name="view" value="processlinks" />
