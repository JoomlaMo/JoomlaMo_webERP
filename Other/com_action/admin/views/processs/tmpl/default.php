...
<div id="tablecell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort',   'Process', 'Process', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th>
	...
	{
		$row = &$this->items[$i];
		$link 		= JRoute::_( 'index.php?option=com_Action&controller=process&task=edit&cid[]='. $row->id);
	...
	?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit process' );?>::<?php echo $row->title; ?>">
...
?>    
	...
	<input type="hidden" name="view" value="processs" />
