...
$js = "
var assetsBase = '".JURI::root()."components/com_actionlist/assets';
var _LOADING_ = '".JText::_('Loading')."';
";
$document->addScriptDeclaration( $js );
$document->addScript( JURI::root(true).'/components/com_actionlist/assets/js/demo_ajax.js' );
$document->addScript( JURI::root(true).'/components/com_actionlist/assets/js/demo_sortables.js' );
$document->addScript( JURI::root(true).'/components/com_actionlist/assets/js/demo_tooltip.js' );

//-- Add css
$document->addStyleSheet('components/com_actionlist/assets/css/demo_accordion.css');
$document->addStyleSheet('components/com_actionlist/assets/css/demo_sortables.css');
$document->addStyleSheet('components/com_actionlist/assets/css/demo_tooltip.css');
...
<p>
	...
	Come and visit <a rel="{handler: 'iframe', size: {x: 970, y: 550}}" href="http://www.joomla.org" class="modal" target="_blank">Joomla.org</a>.
</p>
...
Demo of <span style="color: blue;" class="zoomTip" title="My custom tooltip::Hello world ;)<img src='images/powered_by.png' />">custom formatted tooltips</span>.
