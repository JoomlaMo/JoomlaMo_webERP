...
class teamsModelplayerss extends JModel
{
    var $_data;
    var $_total = null;
    ...
    function __construct()
    {
        ...
        If($mainframe->getUserState( "searchsource") <> 'players'){
        	$this->search='';
        }
    ...
    function _buildQuery()
    {
        ...
        if ($this->search)
        {
            $where[] = 'LOWER(LastName) LIKE \''. $this->search. '\'';
        }
        ...
        if ((($this->filter_order=='FirstName') OR ($this->filter_order=='LastName') OR ($this->filter_order=='Notes') OR ($this->filter_order=='Active')) && ($this->filter_order_Dir))
        {
