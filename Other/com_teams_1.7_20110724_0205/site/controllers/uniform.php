 ...
 * @subpackage Controllers
 */
class teamsControlleruniform extends teamsController
{
    /**
    ...
    {
    	  global $mainframe;	
        $model = $this->getModel('uniform');
		  $post	= (array)JRequest::get('post');

        if( $model->store($post) )
        {
            $msg = JText::_('Record Saved');
        		$link = 'index.php?option=com_teams&view=uniformss';
        ...
        else
        {
            ...
            $msg = JText::_('Error - Record Not Saved');
        		$link = 'index.php?option=com_teams&controller=uniform&task=add&view=uniform&layout=form';
        		$this->setRedirect($link, $msg);
        }
    ...
    function delete()
    {
        ...
        $this->setRedirect( 'index.php?option=com_teams&view=uniformss', $msg );
    }// function
