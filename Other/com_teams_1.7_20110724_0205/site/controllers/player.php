...
// echo "stop23playercontorller<br>";exit;
//-- No direct access
 ...
 * @subpackage Controllers
 */
class teamsControllerplayer extends teamsController
{
    /**
    ...
    function save()
    {
        ...
        if( $model->store($post) )
        {
            $msg = JText::_('Record Saved');
        		$link = 'index.php?option=com_teams&view=playerss';
        ...
        else
        {
            ...
            $msg = JText::_('Error - Record Not Saved');
        		$link = 'index.php?option=com_teams&controller=player&task=add&view=player&layout=form';
        		$this->setRedirect($link, $msg);
        }
    ...
    function delete()
    {
        ...
        $this->setRedirect( 'index.php?option=com_teams&view=playerss', $msg );
    }// function
