 ...
 * @subpackage Controllers
 */
class teamlistControllerteams extends baseballsoftwareListController
{
    /**
    ...
    function save()
    {
        $model = $this->getModel('baseballsoftware');
        ...
        $link = 'index.php?option=com_baseballsoftware';
    ...
    function remove()
    {
        ...
        $this->setRedirect('index.php?option=com_baseballsoftware', $msg);
    }// function
